...
self["${s}"]();`, document.head.appendChild(e);
    ...
    window._$RuntimeInterface$_ = class P0 {
        constructor(t) {
            ...
            this._$IsAnyWebView2Wrapper$_() ? self.chrome.webview.addEventListener("message", t => this._$_OnWrapperMessage$_(t.data, t.additionalObjects)) : "macos-wkwebview" === this._$_exportType$_ ? self.C3WrapperOnMessage = t => this._$_OnWrapperMessage$_(t) : "linux-cef" === this._$_exportType$_ && self.c3_linux_cef_set_message_callback(t => this._$_OnWrapperMessage$_(JSON.parse(t))), 
        ...
        *_$_CanDoAndroidVirtualKeyboardDetection$_() {
        ...
        async _$_Init$_(t) {
            ...
            if ("macos-wkwebview" === this._$_exportType$_) this._$_SendWrapperMessage$_({
                type: "ready"
            }); else if (this._$IsAnyWebView2Wrapper$_() || "linux-cef" === this._$_exportType$_) {
        ...
        _$_OnWrapperMessage$_(t, s) {
            if ("entered-fullscreen" === t) P0._$_SetWrapperIsFullscreenFlag$_(!0), 
            this._$_runtimeDomHandler$_._$_OnFullscreenChange$_(); else if ("exited-fullscreen" === t) P0._$_SetWrapperIsFullscreenFlag$_(!1), 
...
{
    const Od = self._$RuntimeInterface$_;
    ...
    const Pd = new Map([ [ "OSLeft", "MetaLeft" ], [ "OSRight", "MetaRight" ] ]), Qd = {
    ...
    const Td = new Set([ "input", "textarea", "datalist", "select" ]);
    function IsKeyboardInputElement(t) {
        return Td.has(t.tagName.toLowerCase()) || IsInContentEditable(t);
    }
    const Ud = new Set([ "canvas", "body", "html" ]);
    function PreventDefaultOnCanvasOrDoc(t) {
        if (t.target.tagName) {
            const s = t.target.tagName.toLowerCase();
            Ud.has(s) && t.preventDefault();
        }
    }
    ...
    const Wd = "runtime", Xd = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, Wd), this._$_enableWindowResizeEvent$_ = !1, this._$_simulatedResizeTimerId$_ = -1, 
        ...
        _$Attach$_() {
            ...
            window.addEventListener("mousedown", t => this._$_OnMouseEvent$_("mousedown", t, Rd)), 
            window.addEventListener("mousemove", t => this._$_OnMouseEvent$_("mousemove", t, Rd)), 
            window.addEventListener("mouseup", t => this._$_OnMouseEvent$_("mouseup", t, Rd)), 
            window.addEventListener("dblclick", t => this._$_OnMouseEvent$_("dblclick", t, Qd)), 
            window.addEventListener("wheel", t => this._$_OnMouseWheelEvent$_("wheel", t, Qd)), 
        ...
        _$_PostRuntimeEvent$_(t, s) {
            this._$PostToRuntime$_(t, s || null, Sd);
        }
        _$_GetWindowInnerWidth$_() {
        ...
        _$_OnWindowResize$_() {
            if (!this._$_isExportToVideo$_ && this._$_enableWindowResizeEvent$_) {
                ...
                this._$PostToRuntime$_("window-resize", {
                    ...
                    innerHeight: s,
                    devicePixelRatio: window.devicePixelRatio,
                    isFullscreen: Od._$IsDocumentFullscreen$_(),
        ...
        _$_OnFullscreenChange$_() {
            if (!this._$_isExportToVideo$_) {
                const t = Od._$IsDocumentFullscreen$_();
        ...
        _$_OnPointerEvent$_(s, i) {
            if (!this._$_isExportToVideo$_) {
                ...
                }, Qd), "mouse" === i.pointerType && (this._$_mousePointerLastButtons$_ = i.buttons);
            }
        }
    ...
    Od._$AddDOMHandlerClass$_(Xd);
}

{
    const Cf = "dispatchworker.js", Df = "jobworker.js";
    self._$JobSchedulerDOM$_ = class {
        ...
        async _$Init$_() {
            ...
            const t = this._$_runtimeInterface$_._$GetScriptFolder$_() + Cf, s = (this._$_dispatchWorker$_ = await this._$_runtimeInterface$_._$CreateWorker$_(t, {
                name: "DispatchWorker"
            }), new MessageChannel());
        ...
        async _$_CreateJobWorker$_() {
            const t = this._$_jobWorkers$_.length, s = this._$_runtimeInterface$_._$GetScriptFolder$_() + Df, i = await this._$_runtimeInterface$_._$CreateWorker$_(s, {
                name: "JobWorker" + t
...
{
    const Mf = 180 / Math.PI, Nf = "audio";
    self._$AudioDOMHandler$_ = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, Nf), this._$_audioContext$_ = null, this._$_destinationNode$_ = null, 
...

{
    ...
    self._$C3AudioFilterFX$_ = class extends Q8 {
    ...
    }, self._$C3AudioDelayFX$_ = class extends Q8 {
        constructor(t, s, i, e) {
    ...
    }, self._$C3AudioConvolveFX$_ = class extends Q8 {
        constructor(t, s, i, e) {
    ...
    }, self._$C3AudioFlangerFX$_ = class extends Q8 {
        constructor(t, s, i, e, h, n) {
    ...
    }, self._$C3AudioPhaserFX$_ = class extends Q8 {
        constructor(t, s, i, e, h, n, o) {
    ...
    }, self._$C3AudioGainFX$_ = class extends Q8 {
        constructor(t, s) {
    ...
    }, self._$C3AudioStereoPanFX$_ = class extends Q8 {
        constructor(t, s) {
    ...
    }, self._$C3AudioTremoloFX$_ = class extends Q8 {
        constructor(t, s, i) {
    ...
    }, self._$C3AudioRingModFX$_ = class extends Q8 {
        constructor(t, s, i) {
    ...
    }, self._$C3AudioDistortionFX$_ = class extends Q8 {
        constructor(t, s, i, e, h, n) {
    ...
    }, self._$C3AudioCompressorFX$_ = class extends Q8 {
        constructor(t, s, i, e, h, n) {
        ...
        _$SetParam$_(t, s, i, e) {}
    }, self._$C3AudioAnalyserFX$_ = class extends Q8 {
        constructor(t, s, i) {
...

{
    const Dk = "gamepad";
    let s = !1;
    const Fk = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, Dk), this._$_isReady$_ = !1, this._$_timerId$_ = -1, this._$AddRuntimeMessageHandler$_("ready", () => this._$_OnReady$_()), 
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(Fk);
}

{
    const ll = "mouse", ml = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, ll), this._$AddRuntimeMessageHandlers$_([ [ "cursor", t => this._$_OnChangeCursorStyle$_(t) ], [ "request-pointer-lock", t => this._$_OnRequestPointerLock$_(t) ], [ "release-pointer-lock", () => this._$_OnReleasePointerLock$_() ] ]), 
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(ml);
}

{
    const ul = "touch", vl = class extends self._$DOMHandler$_ {
        constructor(t) {
            super(t, ul), this._$AddRuntimeMessageHandler$_("request-permission", t => this._$_OnRequestPermission$_(t));
        }
    ...
    self._$RuntimeInterface$_._$AddDOMHandlerClass$_(vl);
}
